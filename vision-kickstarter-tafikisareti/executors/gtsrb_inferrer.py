...
class GtsrbInferrer:
    def __init__(self):
        ...
        self.saved_path = '/home/arslan/Desktop/vision-kickstarter-tafikisareti/weights/gtsrb/Trafic_signs_model.h5'
    ...
    def infer(self, image=np.array):
        ...
        self.model.load_weights("/home/arslan/Desktop/vision-kickstarter-tafikisareti/weights/gtsrb/Trafic_signs_model_weights.h5")
